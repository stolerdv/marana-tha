        ...
        <section className="bg-[var(--color-cream)]" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
          <div style={{ paddingLeft: "235px", paddingRight: "235px" }}>
            <div className="flex gap-20 items-start">
              ...
              {/* Nearest events sidebar */}
              {events.length > 0 && (
                <div style={{ width: "320px", flexShrink: 0 }}>
                  <p style={{ fontFamily: "var(--font-commissioner)", fontSize: "24px", fontWeight: 700, color: "#1c1d1e", marginBottom: "20px" }}>
                    Najbližšie udalosti
                  </p>
                    ...
                    {events.map((event, i) => (
                      <div key={event.id}>
                        ...
                        <div className="py-4">
                          ...
                          >
                            <p style={{ fontFamily: "var(--font-commissioner)", fontSize: "16px", fontWeight: 700, color: "#1c1d1e" }}>{event.title}</p>
                          </Link>
                          <p style={{ fontFamily: "var(--font-commissioner)", fontSize: "14px", color: "#635f5b", marginTop: "2px" }}>
                  ...
                  <Link href="/udalosti" style={{ fontFamily: "var(--font-commissioner)", fontSize: "14px", fontWeight: 700, color: "#977d3e", display: "block", marginTop: "12px" }}>
                    Všetky udalosti →
                  </Link>
                </div>
              )}
