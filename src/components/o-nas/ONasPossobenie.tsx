...
export function ONasPossobenie() {
  return (
    <section className="bg-[var(--color-cream)] overflow-hidden">
      ...
      <div className="relative" style={{ paddingLeft: "235px", paddingRight: "235px", height: "550px" }}>
      ...
      <div className="relative" style={{ paddingLeft: "235px", paddingRight: "235px", height: "600px" }}>
